...
| [ValidateAll\(Func&lt;RetCode&gt;\[\]\)](ValidationHelper.ValidateAll(Func_RetCode_[]).md 'TechnicalAnalysis\.Common\.ValidationHelper\.ValidateAll\(System\.Func\<TechnicalAnalysis\.Common\.RetCode\>\[\]\)') | Executes multiple validation functions sequentially, returning the first error encountered\. |
