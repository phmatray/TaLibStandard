...
```csharp
public static TechnicalAnalysis.Functions.SumResult Sum(int startIdx, int endIdx, double[] real, int timePeriod=30);
```
#### Parameters
...
```csharp
public static TechnicalAnalysis.Functions.SumResult Sum(int startIdx, int endIdx, float[] real, int timePeriod=30);
```
#### Parameters
...
The number of periods to sum\. Default is 30\.
