...
```csharp
public static TechnicalAnalysis.Functions.KamaResult Kama(int startIdx, int endIdx, double[] real, int timePeriod=30);
```
#### Parameters
...
```csharp
public static TechnicalAnalysis.Functions.KamaResult Kama(int startIdx, int endIdx, float[] real, int timePeriod=30);
```
#### Parameters
