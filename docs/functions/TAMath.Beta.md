...
```csharp
public static TechnicalAnalysis.Functions.BetaResult Beta(int startIdx, int endIdx, double[] real0, double[] real1, int timePeriod=5);
```
#### Parameters
...
```csharp
public static TechnicalAnalysis.Functions.BetaResult Beta(int startIdx, int endIdx, float[] real0, float[] real1, int timePeriod=5);
```
#### Parameters
