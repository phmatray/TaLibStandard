...
```csharp
public static TechnicalAnalysis.Functions.WmaResult Wma(int startIdx, int endIdx, double[] real, int timePeriod=30);
```
#### Parameters
...
```csharp
public static TechnicalAnalysis.Functions.WmaResult Wma(int startIdx, int endIdx, float[] real, int timePeriod=30);
```
#### Parameters
