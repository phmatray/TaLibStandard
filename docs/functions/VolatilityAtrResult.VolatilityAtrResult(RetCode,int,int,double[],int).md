...
## VolatilityAtrResult\(RetCode, int, int, double\[\], int\) Constructor

Represents the result of an Average True Range \(ATR\) volatility analysis\.

```csharp
public VolatilityAtrResult(TechnicalAnalysis.Common.RetCode RetCode, int BegIdx, int NBElement, double[] Values, int Period);
```
#### Parameters

<a name='TechnicalAnalysis.Functions.VolatilityAtrResult.VolatilityAtrResult(TechnicalAnalysis.Common.RetCode,int,int,double[],int).RetCode'></a>
...
<a name='TechnicalAnalysis.Functions.VolatilityAtrResult.VolatilityAtrResult(TechnicalAnalysis.Common.RetCode,int,int,double[],int).BegIdx'></a>
...
<a name='TechnicalAnalysis.Functions.VolatilityAtrResult.VolatilityAtrResult(TechnicalAnalysis.Common.RetCode,int,int,double[],int).NBElement'></a>
...
<a name='TechnicalAnalysis.Functions.VolatilityAtrResult.VolatilityAtrResult(TechnicalAnalysis.Common.RetCode,int,int,double[],int).Values'></a>
...
<a name='TechnicalAnalysis.Functions.VolatilityAtrResult.VolatilityAtrResult(TechnicalAnalysis.Common.RetCode,int,int,double[],int).Period'></a>

`Period` [System\.Int32](https://learn.microsoft.com/en-us/dotnet/api/system.int32 'System\.Int32')

The number of periods used in the ATR calculation\.