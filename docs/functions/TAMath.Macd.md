...
```csharp
public static TechnicalAnalysis.Functions.MacdResult Macd(int startIdx, int endIdx, double[] real, int optInFastPeriod=12, int optInSlowPeriod=26, int optInSignalPeriod=9);
```
#### Parameters
...
```csharp
public static TechnicalAnalysis.Functions.MacdResult Macd(int startIdx, int endIdx, float[] real, int optInFastPeriod=12, int optInSlowPeriod=26, int optInSignalPeriod=9);
```
#### Parameters
