...
```csharp
public static TechnicalAnalysis.Functions.LinearRegResult LinearReg(int startIdx, int endIdx, double[] real, int timePeriod=14);
```
#### Parameters
...
```csharp
public static TechnicalAnalysis.Functions.LinearRegResult LinearReg(int startIdx, int endIdx, float[] real, int timePeriod=14);
```
#### Parameters
