...
## PriceSeries\.Open Property

Gets the opening prices\.

```csharp
public System.ReadOnlySpan<double> Open { get; }
```
...
The series carries no opening prices; see [HasOpen](PriceSeries.HasOpen.md 'TechnicalAnalysis\.Functions\.PriceSeries\.HasOpen')\.