...
```csharp
public static TechnicalAnalysis.Functions.T3Result T3(int startIdx, int endIdx, double[] real, int timePeriod=5, double vFactor=0.7);
```
#### Parameters
...
```csharp
public static TechnicalAnalysis.Functions.T3Result T3(int startIdx, int endIdx, float[] real, int timePeriod=5, double vFactor=0.7);
```
#### Parameters
