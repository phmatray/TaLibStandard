...
```csharp
public static TechnicalAnalysis.Functions.DemaResult Dema(int startIdx, int endIdx, double[] real, int timePeriod=30);
```
#### Parameters
...
```csharp
public static TechnicalAnalysis.Functions.DemaResult Dema(int startIdx, int endIdx, float[] real, int timePeriod=30);
```
#### Parameters
