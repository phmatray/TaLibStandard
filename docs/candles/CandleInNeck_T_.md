...
| Constructors | |
| :--- | :--- |
| [CandleInNeck(T[], T[], T[], T[])](CandleInNeck_T_.CandleInNeck(T[],T[],T[],T[]).md 'TechnicalAnalysis.Candles.CandleInNeck<T>.CandleInNeck(T[], T[], T[], T[])') | |

| Methods | |
| :--- | :--- |
| [Compute(int, int)](CandleInNeck_T_.Compute(int,int).md 'TechnicalAnalysis.Candles.CandleInNeck<T>.Compute(int, int)') | |
