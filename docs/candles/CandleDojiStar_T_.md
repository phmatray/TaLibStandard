...
| Constructors | |
| :--- | :--- |
| [CandleDojiStar(T[], T[], T[], T[])](CandleDojiStar_T_.CandleDojiStar(T[],T[],T[],T[]).md 'TechnicalAnalysis.Candles.CandleDojiStar<T>.CandleDojiStar(T[], T[], T[], T[])') | |

| Methods | |
| :--- | :--- |
| [Compute(int, int)](CandleDojiStar_T_.Compute(int,int).md 'TechnicalAnalysis.Candles.CandleDojiStar<T>.Compute(int, int)') | |
