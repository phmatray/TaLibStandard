...
| Constructors | |
| :--- | :--- |
| [Candle2Crows(T[], T[], T[], T[])](Candle2Crows_T_.Candle2Crows(T[],T[],T[],T[]).md 'TechnicalAnalysis.Candles.Candle2Crows<T>.Candle2Crows(T[], T[], T[], T[])') | |

| Methods | |
| :--- | :--- |
| [Compute(int, int)](Candle2Crows_T_.Compute(int,int).md 'TechnicalAnalysis.Candles.Candle2Crows<T>.Compute(int, int)') | |
