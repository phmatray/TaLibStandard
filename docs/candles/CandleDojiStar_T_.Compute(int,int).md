...
## CandleDojiStar\<T\>\.Compute\(int, int\) Method

Computes the [CandleDojiStar&lt;T&gt;](CandleDojiStar_T_.md 'TechnicalAnalysis\.Candles\.CandleDojiStar\<T\>') indicator\.
...
<a name='TechnicalAnalysis.Candles.CandleDojiStar_T_.Compute(int,int).startIdx'></a>

`startIdx` [System\.Int32](https://learn.microsoft.com/en-us/dotnet/api/system.int32 'System\.Int32')

The start index\.

<a name='TechnicalAnalysis.Candles.CandleDojiStar_T_.Compute(int,int).endIdx'></a>
