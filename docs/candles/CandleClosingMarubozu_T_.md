...
| Constructors | |
| :--- | :--- |
| [CandleClosingMarubozu(T[], T[], T[], T[])](CandleClosingMarubozu_T_.CandleClosingMarubozu(T[],T[],T[],T[]).md 'TechnicalAnalysis.Candles.CandleClosingMarubozu<T>.CandleClosingMarubozu(T[], T[], T[], T[])') | |

| Methods | |
| :--- | :--- |
| [Compute(int, int)](CandleClosingMarubozu_T_.Compute(int,int).md 'TechnicalAnalysis.Candles.CandleClosingMarubozu<T>.Compute(int, int)') | |
