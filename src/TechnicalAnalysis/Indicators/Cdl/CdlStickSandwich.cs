...
namespace TechnicalAnalysis
{
    public static partial class TAMath
    {
            ...
            double[] close)
        {
            ...
            CandleStickSandwich candle = new (open, high, low, close);
            RetCode retCode = candle.CdlStickSandwich(startIdx, endIdx, ref outBegIdx, ref outNBElement, ref outInteger);
