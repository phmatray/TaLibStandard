...
namespace TechnicalAnalysis
{
    public static partial class TAMath
    {
            ...
            double[] close)
        {
            ...
            CandleLongLeggedDoji candle = new (open, high, low, close);
            RetCode retCode = candle.CdlLongLeggedDoji(startIdx, endIdx, ref outBegIdx, ref outNBElement, ref outInteger);
