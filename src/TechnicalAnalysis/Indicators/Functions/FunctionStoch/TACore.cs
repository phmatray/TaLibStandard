...
internal static partial class TACore
{
        ...
        ref double[] outSlowD)
    {
        ...
        int lookbackKSlow = new MovingAverageLookback(optInSlowK_Period, optInSlowK_MAType).Result;
        int lookbackDSlow = new MovingAverageLookback(optInSlowD_Period, optInSlowD_MAType).Result;
