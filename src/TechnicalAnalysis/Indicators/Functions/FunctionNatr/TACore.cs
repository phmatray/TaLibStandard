...
using TechnicalAnalysis.Functions.FunctionNatr;
...
internal static partial class TACore
{
        ...
        ref double[] outReal)
    {
        ...
        outBegIdx = 0;
        outNBElement = 0;
        int lookbackTotal = new NatrLookback(optInTimePeriod).Result;
        ...
        {
            return TACore.TrueRange(startIdx, endIdx, inHigh, inLow, inClose, ref outBegIdx, ref outNBElement, ref outReal);
        }
        ...
        if (retCode == RetCode.Success)
        {
            ...
            int outIdx = (int)TechnicalAnalysis.TACore.Globals.unstablePeriod[17];
            while (true)
            {
                if (outIdx == 0)
                {
