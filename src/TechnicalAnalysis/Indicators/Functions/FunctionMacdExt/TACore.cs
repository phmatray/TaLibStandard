...
internal static partial class TACore
{
        ...
        ref double[] outMACDHist)
    {
        ...
        tempInteger = new MovingAverageLookback(optInSlowPeriod, optInSlowMAType).Result;
        if (tempInteger > lookbackLargest)
        {
            lookbackLargest = tempInteger;
        }

        int lookbackSignal = new MovingAverageLookback(optInSignalPeriod, optInSignalMAType).Result;
