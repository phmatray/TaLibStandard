...
public record CandleAdvanceBlockResult : IndicatorBase
{
    ...
    /// <param name="integers">An array of integers indicating the presence of the Advance Block pattern.</param>
    public CandleAdvanceBlockResult(RetCode retCode, int begIdx, int nbElement, int[] integers)
