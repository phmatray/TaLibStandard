...
public record Candle3WhiteSoldiersResult : IndicatorBase
{
    ...
    /// <param name="integers">An array of integers indicating the presence of the Three White Soldiers pattern.</param>
    public Candle3WhiteSoldiersResult(RetCode retCode, int begIdx, int nbElement, int[] integers)
