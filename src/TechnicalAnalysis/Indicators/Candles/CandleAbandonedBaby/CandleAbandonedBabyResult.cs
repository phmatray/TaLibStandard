...
public record CandleAbandonedBabyResult : IndicatorBase
{
    ...
    /// <param name="integers">An array of integers indicating the presence of the Abandoned Baby pattern.</param>
    public CandleAbandonedBabyResult(RetCode retCode, int begIdx, int nbElement, int[] integers)
