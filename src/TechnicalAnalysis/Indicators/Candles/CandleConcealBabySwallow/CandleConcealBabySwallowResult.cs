...
public record CandleConcealBabySwallowResult : IndicatorBase
{
    ...
    /// <param name="integers">An array of integers indicating the presence of the Conceal Baby Swallow pattern.</param>
    public CandleConcealBabySwallowResult(RetCode retCode, int begIdx, int nbElement, int[] integers)
