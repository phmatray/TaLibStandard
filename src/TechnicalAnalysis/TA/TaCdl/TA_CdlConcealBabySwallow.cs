    ...
    internal static partial class TACore
    {
            ...
            ref int[] outInteger)
        {
                ...
                && (inClose[i - 1] < inOpen[i - 1] ? -1 : 1) == -1 && (inClose[i] < inOpen[i] ? -1 : 1) == -1)
            {
                ...
                {
                    num51 = shadowVeryShortPeriodTotal[3] / GetCandleAvgPeriod(ShadowVeryShort);
                }
                else
                {
                    double num50;
                ...
                if (num52 - inLow[i - 3] < Globals.candleSettings[7].factor * num51 / num45)
                {
                    ...
                    if (GetCandleAvgPeriod(ShadowVeryShort) != 0.0)
                    {
                        num43 = shadowVeryShortPeriodTotal[3] / GetCandleAvgPeriod(ShadowVeryShort);
                    }
                    else
                    {
                        double num42;
                    ...
                    if (inHigh[i - 3] - num44 < Globals.candleSettings[7].factor * num43 / num37)
                    {
                        ...
                        if (GetCandleAvgPeriod(ShadowVeryShort) != 0.0)
                        {
                            num35 = shadowVeryShortPeriodTotal[2] / GetCandleAvgPeriod(ShadowVeryShort);
                        }
                        else
                        {
                            double num34;
                        ...
                        if (num36 - inLow[i - 2] < Globals.candleSettings[7].factor * num35 / num29)
                        {
                            ...
                            if (GetCandleAvgPeriod(ShadowVeryShort) != 0.0)
                            {
                                num27 = shadowVeryShortPeriodTotal[2] / GetCandleAvgPeriod(ShadowVeryShort);
                            }
                            else
                            {
                                double num26;
                            ...
                            if (inHigh[i - 2] - num28 < Globals.candleSettings[7].factor * num27 / num21)
                            {
                                ...
                                if (num20 < num19)
                                {
                                    ...
                                    if (inHigh[i - 1] - num18
                                        > Globals.candleSettings[7].factor * num17 / num11
