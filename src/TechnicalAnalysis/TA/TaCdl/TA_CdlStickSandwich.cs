            ...
            ref int[] outInteger)
        {
            ...
            do
            {
                bool isStickSandwich =
                    ...
                    GetCandleAverage(Equal, equalPeriodTotal, i - 2, inOpen, inHigh, inLow, inClose) &&
                    inClose[i] >= inClose[i - 2] -
                    GetCandleAverage(Equal, equalPeriodTotal, i - 2, inOpen, inHigh, inLow, inClose);
                 ...
                 */
                equalPeriodTotal +=
                    GetCandleRange(Equal, i - 2, inOpen, inHigh, inLow, inClose) -
                    GetCandleRange(Equal, equalTrailingIdx - 2, inOpen, inHigh, inLow, inClose);
