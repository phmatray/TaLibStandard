...
namespace TechnicalAnalysis
{
    internal static partial class TACore
    {
            ...
            ref int[] outInteger)
        {
            ...
            {
                num55 = bodyPeriodTotal / GetCandleAvgPeriod(BodyShort);
            }
            else
            {
                double num54;
            ...
            if (Math.Abs(inClose[i] - inOpen[i]) < Globals.candleSettings[2].factor * num55 / num49)
            {
                ...
                {
                    num47 = shadowLongPeriodTotal / GetCandleAvgPeriod(ShadowLong);
                }
                else
                {
                    double num46;
                ...
                if (inHigh[i] - num48 > Globals.candleSettings[4].factor * num47 / num41)
                {
                    ...
                    {
                        num39 = shadowVeryShortPeriodTotal / GetCandleAvgPeriod(ShadowVeryShort);
                    }
                    else
                    {
                        double num38;
