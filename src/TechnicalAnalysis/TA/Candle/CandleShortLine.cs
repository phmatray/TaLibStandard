...
namespace TechnicalAnalysis.Candle
{
    public class CandleShortLine : CandleIndicator
    {
            ...
            ref int[] outInteger)
        {
            ...
            int lookbackTotal = this.CdlShortLineLookback();
            ...
            do
            {
                ...
                outInteger[outIdx++] = isShortLine ? this.GetCandleColor(i, this.open, this.close) * 100 : 0;
        ...
        {
            return Math.Max(this.GetCandleAvgPeriod(BodyShort), this.GetCandleAvgPeriod(ShadowShort));
        }
    }
}
