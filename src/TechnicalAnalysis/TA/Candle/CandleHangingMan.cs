...
namespace TechnicalAnalysis.Candle
{
    public class CandleHangingMan : CandleIndicator
    {
            ...
            ref int[] outInteger)
        {
            ...
            int lookbackTotal = this.CdlHangingManLookback();
            ...
            do
            {
                bool isHangingMan =
                    ...
                    Math.Min(this.close[i], this.open[i]) >=
                    this.high[i - 1] - this.GetCandleAverage(Near, nearPeriodTotal, i - 1, this.open, this.high, this.low, this.close);
