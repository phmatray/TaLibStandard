...
public static partial class TAFunc
{
    ...
    private static RetCode TA_INT_EMA(int startIdx, int endIdx, float[] inReal0, int optInTimePeriod0, double optInK1, ref int outBegIdx, ref int outNbElement, double[] outReal0)
    {
        int today;
        double prevMA;
        int lookbackTotal = EmaLookback(optInTimePeriod0);
    ...
    private static RetCode TA_INT_MACD(int startIdx, int endIdx, float[] inReal0, int optInFastPeriod0, int optInSlowPeriod1, int optInSignalPeriod2, ref int outBegIdx, ref int outNbElement, double[] outMACD0, double[] outMACDSignal1, double[] outMACDHist2)
    {
        int i;
        int tempInteger = 0;
        int outNbElement1 = 0;
    ...
    private static RetCode TA_INT_SMA(int startIdx, int endIdx, float[] inReal0, int optInTimePeriod0, ref int outBegIdx, ref int outNbElement, double[] outReal0)
    {
        int lookbackTotal = optInTimePeriod0 - 1;
    ...
    private static RetCode TA_INT_VAR(int startIdx, int endIdx, float[] inReal0, int optInTimePeriod0, ref int outBegIdx, ref int outNbElement, double[] outReal0)
    {
        double tempReal;
        int nbInitialElementNeeded = optInTimePeriod0 - 1;
