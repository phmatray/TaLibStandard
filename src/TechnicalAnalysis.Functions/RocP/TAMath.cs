...
public static partial class TAMath
{
    ...
    /// </remarks>
    public static RocPResult RocP(int startIdx, int endIdx, double[] real, int timePeriod = 10)
    {
        int outBegIdx = 0;
        int outNBElement = 0;
    ...
    /// </remarks>
    public static RocPResult RocP(int startIdx, int endIdx, float[] real, int timePeriod = 10)
        => TAMathHelper.Execute(startIdx, endIdx, real, (s, e, r) => RocP(s, e, r, timePeriod));
}
