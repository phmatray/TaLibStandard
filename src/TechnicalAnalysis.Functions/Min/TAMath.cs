...
public static partial class TAMath
{
    ...
    /// </remarks>
    public static MinResult Min(int startIdx, int endIdx, double[] real, int timePeriod = 30)
    {
        int outBegIdx = 0;
        int outNBElement = 0;
    ...
    /// </remarks>
    public static MinResult Min(int startIdx, int endIdx, float[] real, int timePeriod = 30)
        => TAMathHelper.Execute(startIdx, endIdx, real, (s, e, r) => Min(s, e, r, timePeriod));
}
