...
public static partial class TAMath
{
    ...
    /// </remarks>
    public static MaxResult Max(int startIdx, int endIdx, double[] real, int timePeriod = 30)
    {
        int outBegIdx = 0;
        int outNBElement = 0;
    ...
    /// </remarks>
    public static MaxResult Max(int startIdx, int endIdx, float[] real, int timePeriod = 30)
        => TAMathHelper.Execute(startIdx, endIdx, real, (s, e, r) => Max(s, e, r, timePeriod));
}
