...
public static partial class TAMath
{
    ...
    /// </returns>
    public static BetaResult Beta(int startIdx, int endIdx, double[] real0, double[] real1, int timePeriod = 5)
    {
        int outBegIdx = 0;
        int outNBElement = 0;
    ...
    /// and associated metadata.
    /// </returns>
    public static BetaResult Beta(int startIdx, int endIdx, float[] real0, float[] real1, int timePeriod = 5)
        => TAMathHelper.Execute(startIdx, endIdx, real0, real1, (s, e, r0, r1) => Beta(s, e, r0, r1, timePeriod));
}
