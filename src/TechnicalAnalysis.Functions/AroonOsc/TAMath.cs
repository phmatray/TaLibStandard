...
public static partial class TAMath
{
    ...
    /// </remarks>
    public static AroonOscResult AroonOsc(int startIdx, int endIdx, double[] high, double[] low, int timePeriod = 14)
    {
        int outBegIdx = 0;
        int outNBElement = 0;
    ...
    /// </remarks>
    public static AroonOscResult AroonOsc(int startIdx, int endIdx, float[] high, float[] low, int timePeriod = 14)
        => TAMathHelper.Execute(startIdx, endIdx, high, low, (s, e, h, l) => AroonOsc(s, e, h, l, timePeriod));
}
