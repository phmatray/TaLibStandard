...
/// </summary>
public record MinIndexResult : IndicatorResult
{
    /// <summary>
    /// Initializes a new instance of the <see cref="MinIndexResult"/> class.
    /// </summary>
    /// <param name="retCode">The return code indicating the success or failure of the calculation.</param>
    /// <param name="begIdx">The index of the first valid data point in the output array.</param>
    /// <param name="nbElement">The number of valid data points in the output array.</param>
    /// <param name="integers">An array containing the indices of minimum values. Each element represents
    ...
    public MinIndexResult(RetCode retCode, int begIdx, int nbElement, int[] integers)
