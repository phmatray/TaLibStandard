...
public record CandleClosingMarubozuResult : IndicatorBase
{
    ...
    /// <param name="integers">An array of integers indicating the presence of the Closing Marubozu pattern.</param>
    public CandleClosingMarubozuResult(RetCode retCode, int begIdx, int nbElement, int[] integers)
