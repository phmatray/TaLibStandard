...
public record Candle2CrowsResult : IndicatorBase
{
    ...
    /// <param name="integers">An array of integers indicating the presence of the Two Crows pattern.</param>
    public Candle2CrowsResult(RetCode retCode, int begIdx, int nbElement, int[] integers)
