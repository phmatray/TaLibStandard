...
public record CandleCounterAttackResult : IndicatorBase
{
    ...
    /// <param name="integers">An array of integers indicating the presence of the Counter Attack pattern.</param>
    public CandleCounterAttackResult(RetCode retCode, int begIdx, int nbElement, int[] integers)
