    ...
    internal partial class TACore
    {
            ...
            int[] outInteger)
        {
            ...
            while (totIdx >= 0)
            {
                ...
                {
                    num45 = Math.Abs(
                        (double)(inClose[ShadowShortTrailingIdx - totIdx] - inOpen[ShadowShortTrailingIdx - totIdx]));
                }
                else
                {
                    double num44;
                    ...
                    else
                    {
                        ...
                        if (Globals.candleSettings[6].rangeType == RangeType.Shadows)
                        {
                            ...
                            num41 = (inHigh[ShadowShortTrailingIdx - totIdx] - num43)
                                    + (num42 - inLow[ShadowShortTrailingIdx - totIdx]);
                        }
                        else
                        {
                            num41 = 0.0;
            ...
            for (totIdx = 1; totIdx >= 0; totIdx--)
            {
                ...
                {
                    num35 = Math.Abs(
                        (double)(inClose[ShadowLongTrailingIdx - totIdx] - inOpen[ShadowLongTrailingIdx - totIdx]));
                }
                else
                {
                    double num34;
                    ...
                    else
                    {
                        ...
                        if (Globals.candleSettings[4].rangeType == RangeType.Shadows)
                        {
                            ...
                            num31 = (inHigh[ShadowLongTrailingIdx - totIdx] - num33)
                                    + (num32 - inLow[ShadowLongTrailingIdx - totIdx]);
                        }
                        else
                        {
                            num31 = 0.0;
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (Globals.candleSettings[9].rangeType == RangeType.Shadows)
                        {
                            ...
                            num21 = (inHigh[FarTrailingIdx - totIdx] - num23)
                                    + (num22 - inLow[FarTrailingIdx - totIdx]);
                        }
                        else
                        {
                            num21 = 0.0;
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (Globals.candleSettings[8].rangeType == RangeType.Shadows)
                        {
                            ...
                            num11 = (inHigh[NearTrailingIdx - totIdx] - num13)
                                    + (num12 - inLow[NearTrailingIdx - totIdx]);
                        }
                        else
                        {
                            num11 = 0.0;
            ...
            int[] outInteger)
        {
            ...
            while (totIdx >= 0)
            {
                ...
                {
                    num45 = Math.Abs(
                        (float)(inClose[ShadowShortTrailingIdx - totIdx] - inOpen[ShadowShortTrailingIdx - totIdx]));
                }
                else
                {
                    float num44;
            ...
            for (totIdx = 1; totIdx >= 0; totIdx--)
            {
                ...
                {
                    num35 = Math.Abs(
                        (float)(inClose[ShadowLongTrailingIdx - totIdx] - inOpen[ShadowLongTrailingIdx - totIdx]));
                }
                else
                {
                    float num34;
