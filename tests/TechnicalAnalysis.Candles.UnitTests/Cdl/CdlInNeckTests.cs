...
public class CdlInNeckTests : CdlTestsBase
{
    ...
    {
        InvokeGeneric(nameof(CdlInNeck), floatingPointType);
    }
    
    private static void CdlInNeck<T>()
        where T : IFloatingPoint<T>
    {
        ...
        // Act
        CandleIndicatorResult result = TACandle.CdlInNeck(
