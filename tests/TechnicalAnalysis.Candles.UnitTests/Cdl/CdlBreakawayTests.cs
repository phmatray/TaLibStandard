...
public class CdlBreakawayTests : CdlTestsBase
{
    ...
    {
        InvokeGeneric(nameof(CdlBreakaway), floatingPointType);
    }
    
    private static void CdlBreakaway<T>()
        where T : IFloatingPoint<T>
    {
        ...
        // Act
        CandleBreakawayResult result = TACandle.CdlBreakaway(
