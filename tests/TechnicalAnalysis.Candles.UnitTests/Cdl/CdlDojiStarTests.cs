...
public class CdlDojiStarTests : CdlTestsBase
{
    ...
    {
        InvokeGeneric(nameof(CdlDojiStar), floatingPointType);
    }
    
    private static void CdlDojiStar<T>()
        where T : IFloatingPoint<T>
    {
        ...
        // Act
        CandleIndicatorResult result = TACandle.CdlDojiStar(
